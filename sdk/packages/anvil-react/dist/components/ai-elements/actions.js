...
export function Action({ tooltip, label, icon: Icon, className, ...props }) {
    ...
    return (_jsxs("div", { className: "relative", children: [_jsx(Button, { variant: "ghost", size: "icon", "aria-label": label, title: tooltip ?? label, ...props, onClick: (e) => { setOpen(false); props.onClick?.(e); }, onMouseEnter: () => setOpen(true), onMouseLeave: () => setOpen(false), className: cn("h-6 w-6 sm:h-7 sm:w-7", className), children: _jsx(Icon, { className: "h-3 w-3 sm:h-3.5 sm:w-3.5" }) }), tooltip && open && (_jsx("div", { className: "absolute bottom-full left-1/2 -translate-x-1/2 mb-1 px-1.5 py-0.5 text-[10px] font-medium bg-popover text-popover-foreground border rounded shadow-sm pointer-events-none whitespace-nowrap z-10", children: tooltip }))] }));
}
