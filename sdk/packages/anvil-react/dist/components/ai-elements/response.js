...
function renderMarkdown(text, sources, renderer) {
    if (!text)
        return "";
    ...
    if (typeof window === "undefined") {
        ...
        const raw = marked.parse(linked, { async: false });
...
export function Response({ children, sources, renderer, className, ...props }) {
    const [mounted, setMounted] = React.useState(false);
    React.useEffect(() => setMounted(true), []);
    const html = React.useMemo(() => renderMarkdown(children, sources, renderer), 
